 ...
 */
class m230114_151227_add_tree_tags_databank_file extends Migration
{
    const ROLE_ROOT = 1;
    ...
    public function safeUp()
    {
        ...
        $roleRootTag1->nome = "Tag liberi databank file";
//        $roleRootTag1->limit_selected_tag = 3;
        $roleRootTag1->codice = \open20\amos\attachments\models\AttachDatabankFile::ROOT_TAG_DATABANK_FILE;
